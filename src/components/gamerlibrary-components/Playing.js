                                ...
                                <div key={playingEntry._id}>
                                    {playingEntry.games.map((game) => (
                                        <div key={game.title} className="library-row">
                                            ...
                                            <h4 className="library-title">{game.title} <IconButton onClick={() => removeFromPlayingLibrary(game._id)}><HighlightOffIcon sx={{ color: "red" }} className="delete-button" /></IconButton></h4>
                                        </div>
                                    ))}
                                </div>
                            ))}
